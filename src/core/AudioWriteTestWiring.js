var AudioWriteTestWiring = (function () {
	var BUTTON_ID = "test-audio-parameter-write-btn";
	var HANDLER = "invokeAudioParameterWriteTest";
	var BRIDGE_METHOD = "testAudioParameterWrite";
	var BRIDGE_PATH = "audio-parameter-write-test";
	var GENERIC_BRIDGE_METHOD = "testParameterWrite";
	var GENERIC_BRIDGE_PATH = "generic-parameter-write-test";
	var HOST_FUNCTION = "debugAudioParameterWriteTest";
	...
	var NOT_LOADED = "AUDIO_WRITE_TEST_PATH_NOT_LOADED";
	...
	function notLoadedPayload(ident) {
		...
		payload = {
			...
			operation: OPERATION,
			reason: NOT_LOADED,
			detail: "AudioParameterWriteTest.js is not loaded in the ExtendScript host. Audio path does not fall back to ParameterWriteTest or UniversalParameterResolver.",
	...
	function buildLoadProbeScript() {
		return "(function(){var q=$._pickfx;return JSON.stringify({ok:true,operation:\"audio.parameter.write.test.probe\",audioWriteTestLoaded:!!(q&&q.__audioWriteTestLoaded===true),audioWriteTestFunctionAvailable:!!(q&&typeof q.debugAudioParameterWriteTest===\"function\"),genericHostFunctionAvailable:!!(q&&typeof q.testParameterWrite===\"function\"),hostFunction:(q&&typeof q.debugAudioParameterWriteTest===\"function\")?\"debugAudioParameterWriteTest\":\"missing\"});})()";
	}
	...
	function hostFunctionFromScript(script) {
		script = String(script || "");
		if (script.indexOf("$._pickfx.debugAudioParameterWriteTest(") !== -1) {
	...
	function attachTrace(result, ident) {
		...
		if (typeof $ !== "undefined" && $._pickfx) {
			result.audioWriteTestLoaded = $._pickfx.__audioWriteTestLoaded === true;
			result.audioWriteTestFunctionAvailable = typeof $._pickfx.debugAudioParameterWriteTest === "function";
		} else {
			result.audioWriteTestLoaded = typeof AudioParameterWriteTest !== "undefined";
			result.audioWriteTestFunctionAvailable = typeof AudioParameterWriteTest !== "undefined" &&
				typeof AudioParameterWriteTest.hostDebugRun === "function";
		}
		return result;
	}
...
if (typeof $ !== "undefined") {
	$._pickfxAudioWriteTestWiring = AudioWriteTestWiring;
}

if (typeof module !== "undefined" && module.exports) {
	module.exports = AudioWriteTestWiring;
}
